...
// Define a context for managing theme
...
export default function Home() {
  ...
  const toggleTheme = () => {
    ...
    setTheme(newTheme);
    localStorage.setItem("theme", newTheme); // Persist theme preference in localStorage
  };
  ...
  return (
    <ThemeContext.Provider value={{ theme, toggleTheme }}>
      ...
      >
            ...
            <div className="w-full gap-4 ">
              <div className="flex flex-col gap-4 text-center w-full md:text-justify">
                ...
                <p className="text-xl">
                  ...
                  Institution. Now, I am focused on mastering my skills in PHP,
                  Laravel, React, Vue. My goal is to contribute to impactful
                  projects that solve real-world problems and to collaborate
                  with talented teams to achieve excellence in software
                  development.
                </p>
              </div>
              <div className="mt-4 flex flex-col gap-4 md:flex-row">
                <a
                  href="/files/AMARO, Resume.pdf"
                  download
        ...
        <button
          className="fixed right-4 bottom-4 p-3 rounded-full bg-blue-500 text-white hover:bg-blue-600"
          onClick={toggleTheme}
        >
